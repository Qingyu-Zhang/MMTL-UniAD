...
class TotalNet(nn.Module):
    def __init__(self):
        ...
        self.marnet1 = BiLevelRoutingAttention(512)
        self.marnet2 = BiLevelRoutingAttention(512)
        self.marnet3 = BiLevelRoutingAttention(512)
        self.marnet4 = BiLevelRoutingAttention(512)
